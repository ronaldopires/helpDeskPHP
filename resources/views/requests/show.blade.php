  ...
  <div class="container content-main">
    <div class="row g-0 content-request">
      ...
      <div class="col-md-12 mt-3">
        <form class="row g-3" action="/chamado/update/{{ $request->id }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="col-md-3">
          ...
          <div class="col-md-2">
            ...
            <select class="form-select" aria-label="origin_of_requisition" id="origin_of_requisition" name="request"
              required>
          ...
          <div class="col-md-2">
            ...
            <input type="text" class="form-control" id="problem" name="problem" value="{{ $request->problem }}"
              required />
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-12">
            ...
            <textarea rows="5" class="form-control" aria-label="With textarea" id="observation" name="observation"
              required>{{ $request->observation }}</textarea>
          </div>
          <div class="col-md-12">
